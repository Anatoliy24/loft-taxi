    ...
    return (
        <header className="header">
            <svg width="272" height="61" className='header-logo' viewBox="0 0 272 61" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M10.0535 10.1304L13.8275 13.9044" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M18.127 48.8896L14.3529 52.6637" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M24.8549 41.7133L21.0808 45.4873" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M31.5829 34.5367L27.8089 38.3108" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M45.0387 20.1838L41.2647 23.9579" stroke="#FDBF5A" strokeWidth="4"/>
                <path d="M51.7666 13.0073L47.9926 16.7813" stroke="#FDBF5A" strokeWidth="4"/>
