        ...
        <div className="login-page">
            <div className="login-page__left">
                <svg className='img-logo_big' width="196" height="228" viewBox="0 0 196 228" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fillRule="evenodd" clipRule="evenodd" d="M97 136C134.555 136 165 105.555 165 68C165 60.1133 163.657 52.5401 161.188 45.4967L74.4967 132.188C81.5401 134.657 89.1133 136 97 136ZM42.0509 108.065L75.416 74.7003L36.8913 36.1756C31.8536 45.6708 29 56.5022 29 68C29 82.9801 33.8439 96.8289 42.0509 108.065ZM65.1756 7.89132L103.7 46.416L137.065 13.0509C125.829 4.84392 111.98 0 97 0C85.5022 0 74.6708 2.85364 65.1756 7.89132Z" fill="#FDBF5A"/>
                    <path d="M51.4142 22.5857L59.8284 30.9999" stroke="#FDBF5A" strokeWidth="4"/>
                    <path d="M69.4142 109L61 117.414" stroke="#FDBF5A" strokeWidth="4"/>
                    <path d="M84.4142 93L76 101.414" stroke="#FDBF5A" strokeWidth="4"/>
                    <path d="M99.4142 77L91 85.4142" stroke="#FDBF5A" strokeWidth="4"/>
